...
describe('POST /v2/admin/quiz/{quizId}/question (adminQuizQuestionCreate)', () => {
  ...
  describe('Error cases', () => {
    test('Invalid session', () => {
      ...
      const res = reqAdminQuizQuestionCreateV2(quizId, sessionInvalid,
    ...
    test('Invalid quizId', () => {
      const res = reqAdminQuizQuestionCreateV2(quizId + 1, session,
        'Is this question valid?', 4, 5,
        [
          {
            answer: 'Yes',
    ...
    test('Quiz belongs to another user', () => {
      ...
      const res = reqAdminQuizQuestionCreateV2(quizId, session2,
        'Is this question valid?', 4, 5,
        [
          {
            answer: 'Yes',
    ...
    test.each([
      ...
      const res = reqAdminQuizQuestionCreateV2(quizId, session, Question, 4, 5,
        [
          {
            answer: 'Yes',
            correct: false
    ...
    test.each([
      ...
      const res = reqAdminQuizQuestionCreateV2(quizId, session,
    ...
    test('Sum of questions which exceeds 3 minutes(same question)', () => {
      ...
      const res1 = reqAdminQuizQuestionCreateV2(quizId, session, 'Is this question valid?', 100, 5,
        [
          {
            answer: 'Yes',
            correct: true
      ...
      const res2 = reqAdminQuizQuestionCreateV2(quizId, session,
      ...
      const res3 = reqAdminQuizQuestionCreateV2(quizId, session,
